	...
	<div class="content-wrapper">
		...
		<div class="content">
			...
			<table id="tableReport" class="cell-border hover" style="width: 100%;">
				<thead>
					<tr>
						<th rowspan="2" id="name1">클러스터</th>
						<th rowspan="2" id="name2">호스트</th>
						<th rowspan="2">가상머신</th>
						<th rowspan="2">vCPU</th>
						<th rowspan="2">Memory</th>
						<th rowspan="2">총 Disk</th>
						<th rowspan="2">OS</th>
	...
	<script type="text/javascript">
		...
		function getReportCluster(cycle, clusterId, hostId, inputDate) {
			var tableReport = $('#tableReport').addClass('nowrap').DataTable({
				...
				ajax: {
					url: '/report/selectVMDayNightReportList.do',
					type: 'POST',
					dataSrc: '',
					data: {
						timeset : cycle,
