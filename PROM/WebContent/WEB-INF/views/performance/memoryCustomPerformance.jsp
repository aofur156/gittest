			...
			<div class="card Inquire-card">
				<div class="row">
					...
					<div class="col-group w-50">
						<div class="input-group">
							<div class="input-group-prepend"><span class="input-group-text">Memory</span></div>
							<input type="number" class="form-control" min="0" max="100" placeholder="입력" value="70" id="inputMemory">
						</div>
					</div>
					<div class="col-group w-50">
	...
	<script type="text/javascript">
		...
		function getCustomResourceList(cpu, memory, clusterId, clusterName, serviceGroupId, serviceGroupName, category) {
			var tableResourcePerformance = $('#tableResourcePerformance').addClass('nowrap').DataTable({
				...
				ajax: {
					url: '/performance/selectVMOvermemoryList.do',
					type: 'POST',
					dataSrc: '',
					data: {
