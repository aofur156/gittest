...
<body>
	...
	<c:if test="${null ne updateQuestions}">
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<!-- 타이틀 -->
				<div class="table-header"><h6>문의 변경</h6></div>

				<!-- 텍스트 에디터 카드 -->
				<div class="card textEditor-card">
					<div class="card-header">
						<label class="mb-0">제목 : </label>
						<input type="text" class="form-control mb-0" placeholder="제목을 입력해 주세요. (100자 이내)" autocomplete="off" maxlength="100" id="questionTitle" value="${updateQuestions.title}">
					</div>
					<div class="card-body">
						<div id="questionSummernote">${updateQuestions.question}</div>
					</div>
				</div>

				<!-- 등록 버튼 -->
				<div class="textEditor-button">
					<button type="button" class="btn" onclick="updateQuestion()">수정</button>
	...
	<script type="text/javascript">
		...
		function updateCancel() {
			...
			// 취소 확인
			if (confirm('문의 변경을 취소하시겠습니까?') == true) {
