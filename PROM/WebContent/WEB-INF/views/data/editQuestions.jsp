	...
	<body>
		<div class="card bg-dark mb-0">
			<div class="helpDesk-header">
				<div class="row">
					...
					<div class="col-xl-11 col-sm-10">
						<input type="text" class="form-control" placeholder="제목을 입력하십시오. (100자 이내)" autocomplete="off" maxlength="100" id="questionsTitle">
					</div>
				</div>
			</div>
			<div class="helpDesk-body">
				<div id="questionsSummernote"></div>
			</div>
			<div class="helpDesk-footer justify-content-end">
				...
				<button type="button" class="btn bg-prom rounded-round ml-2-5" onclick="setQuestion()">문의 등록<i class="icon-checkmark2 ml-2"></i></button>
				...
				$.ajax({
					...
					success: function(data) {
						...
						if (temp_FilesName.length == 0) {
							$('#questionsSummernote').summernote('editor.insertText', ' ');
						}
					}
				});
			}
