...
<body>
	...
	<div class="content-wrapper">
		...
		<!-- 본문 시작 -->
		<div class="content">
			<table id="tableApplyApproval" class="cell-border hover" style="width: 100%">
				<thead>
					<tr>
						<th>아이디</th>
						<th>이름</th>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			getApplyApprovalList();
		});
		
		function getApplyApprovalList() {
			var tableApplyApproval = $('#tableApplyApproval').addClass('nowrap').DataTable({
