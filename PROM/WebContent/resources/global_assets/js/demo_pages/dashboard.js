...
var Dashboard = function () {
    ...
    return {
        ...
        initCharts: function() {
            ...
            _RoundedProgressChart('#hours-available-progress', 38, 2, '#F06292', 0.68, 'icon-watch text-pink-400', 'CPU', '64% average');
            _RoundedProgressChart('#goal-progress', 38, 2, '#5C6BC0', 0.82, 'icon-trophy3 text-indigo-400', 'MEMORY', '87% average');
