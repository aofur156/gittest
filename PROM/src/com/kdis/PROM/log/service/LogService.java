...
public interface LogService {
	 ...
	 * 이력 등록
	 * 
	 * @param sReceive 이력 받는사람 
	 * @param nCategory 이력 구분자 
	 * @param sContext 이력 내용 
	 * @param sTarget 이력 상세 구분자 
	 * @param sKeyword 이력 구분자(문자열) 
	 */
	public void insertLog(String sReceive, int nCategory, 
			String sContext, String sTarget, String sKeyword);
	 ...
	 * @param sKeyword 이력 구분자(문자열) 
	 */
	public void insertLog(int nCategory, 
			String sContext, String sTarget, String sKeyword);
